...
* The GEDCOM 5.5.5 specification has been implemented. This is the bulk of the internal data structures required (records.R, subrecords.R, validate_primitives.R, and docs_primitives.R);
...
* Current work is on implementing some sophisticated functionality for sources and events, and other utility functions;
...
* `tidygedcom.internals` will contain the internal data structures currently in this package;
