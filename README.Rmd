...
tg <- gedcom(subm("Jamie Lendrum")) %>%
  ...
  add_individual_names_var(primary_name = "Anakin Skywalker", variation_name = "Darth Vader", type = "aka",
                           prefix = "Darth", variation_notes = "Title bestowed by Emperor Palpatine") %>% 
  add_individual_event(event_type = "DEAT", age_at_event = "45y", event_notes = "Killed by son Luke",
