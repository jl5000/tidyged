...
Import, create, and summarise family tree GEDCOM files using tidy dataframes. This package is still in heavy development with the first operational version unlikely to be complete before October 2020.
...
* The GEDCOM 5.5.1 specification has been implemented. This is the bulk of the internal data structures required (params.R, structures.R, records.R, and validate_params.R);
...
* Work on `tgvis` and `tgedit` will begin once an initial version of `tidygedcom` is complete.
