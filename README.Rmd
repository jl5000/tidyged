...
The package and its internal data structures (contained in a separate `tidyged.internals` package) are almost complete and will soon be submitted to CRAN. As is a separarate `tidyged.io` package to allow import/export of `tidyged` objects.

Further packages are also planned, to provide an ecosystem called the `gedcompendium`, including:
