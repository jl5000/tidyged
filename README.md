...
tg <- gedcom(subm("Jamie Lendrum"), gedcom_description = "The Skywalker family", gedcom_copyright = "None") %>%
  ...
  add_indi_names(name_pieces(given = "Obi-Wan", nickname = "Ben", surname = "Kenobi"), 
                 type = "birth") %>% 
  add_famg(husband = find_xref(., c(INDI.NAME.GIVN = "Anakin")), 
           wife = find_xref(., c(INDI.NAME.GIVN = "Padme")), 
           children = find_xref(., c(INDI.NAME.GIVN = "Luke|Leia"), multiple = TRUE)) %>%
  activate_indi(find_xref(., c(INDI.NAME.GIVN = "Anakin"))) %>% 
  add_indi_association(find_xref(., c(INDI.NAME.GIVN = "Obi-Wan")), 
                       association = "Master") %>% 
...
|:-----|:-----------------|:----|:----------------|:-----------------|:----------------|:------------------|:--------------|:-----------------|:--------------|--------------:|:---------------|
| @I1@ | Anakin Skywalker | M   |                 |                  |                 | Second Death Star |               |                  |               |             2 | 15 AUG 2021    |
| @I2@ | Padme Amidala    | F   |                 |                  |                 |                   |               |                  |               |             2 | 15 AUG 2021    |
| @I3@ | Leia Skywalker   | F   |                 |                  |                 |                   | Padme Amidala | Anakin Skywalker | 1             |             0 | 15 AUG 2021    |
| @I4@ | Luke Skywalker   | M   |                 |                  |                 |                   | Padme Amidala | Anakin Skywalker | 1             |             0 | 15 AUG 2021    |
| @I5@ | Obi-Wan Kenobi   | M   |                 |                  |                 |                   |               |                  |               |             0 | 15 AUG 2021    |
...
|:-----|:-----------------|:--------------|:---------------|:----------------|:--------------|:---------------|
| @F1@ | Anakin Skywalker | Padme Amidala |                |                 | 2             | 15 AUG 2021    |
