...
| :--- | :--------------- | :-- | :-------------- | :--------------- | :-------------- | :---------------- | :------------ | :--------------- | :------------ | ------------: | :------------- |
| @I1@ | Anakin Skywalker | M   |                 |                  |                 | Second Death Star |               |                  |               |             2 | 3 FEB 2021     |
| @I2@ | Padme Amidala    | F   |                 |                  |                 |                   |               |                  |               |             2 | 3 FEB 2021     |
| @I3@ | Leia Skywalker   | F   |                 |                  |                 |                   | Padme Amidala | Anakin Skywalker | 1             |             0 | 3 FEB 2021     |
| @I4@ | Luke Skywalker   | M   |                 |                  |                 |                   | Padme Amidala | Anakin Skywalker | 1             |             0 | 3 FEB 2021     |
| @I5@ | Obi-Wan Kenobi   | M   |                 |                  |                 |                   |               |                  |               |             0 | 3 FEB 2021     |
...
| :--- | :--------------- | :------------ | :------------- | :-------------- | :------------ | :------------- |
| @F1@ | Anakin Skywalker | Padme Amidala |                |                 | 2             | 3 FEB 2021     |
...
submitted to CRAN. As is a separarate `tidyged.io` package to allow
import/export of `tidyged` objects.

Further packages are also planned, to provide an ecosystem called the
`gedcompendium`, including:
