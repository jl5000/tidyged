...
test_that("date_exact_pattern gives expected values", {
...
test_that("date_pattern gives expected values", {
...
test_that("date_period_pattern gives expected values", {
...
test_that("date_range_pattern gives expected values", {
...
test_that("date_approximated_pattern gives expected values", {
...
test_that("date_value_pattern gives expected values", {
...
test_that("date_value gives expected values", {
