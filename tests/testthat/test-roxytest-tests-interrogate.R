...
test_that("Function describe_family_group() @ L140", {
...
test_that("Function df_individuals() @ L429", {
...
test_that("Function df_families() @ L487", {
  expect_snapshot_value(gedcom(subm("Me")) %>% 
   add_individual(sex = "M") %>% 
   add_individual_names("Joe /Bloggs/") %>% 
   add_individual(sex = "F") %>% 
...
test_that("Function df_multimedia() @ L521", {
  expect_snapshot_value(gedcom(subm("Me")) %>% 
...
test_that("Function df_sources() @ L548", {
  expect_snapshot_value(gedcom(subm("Me")) %>% 
...
test_that("Function df_repositories() @ L571", {
  expect_snapshot_value(gedcom(subm("Me")) %>% 
...
test_that("Function df_notes() @ L598", {
  expect_snapshot_value(gedcom(subm("Me")) %>% 
