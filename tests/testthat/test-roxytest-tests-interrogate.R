...
test_that("Function str.tidyged() @ L423", {
  expect_snapshot_value(
   gedcom(subm("Me")) %>% 
    add_indi() %>% 
    add_indi() %>% 
...
test_that("Function df_indi() @ L469", {
...
test_that("Function df_famg() @ L527", {
  expect_snapshot_value(gedcom(subm("Me")) %>% 
   add_indi(sex = "M") %>% 
   add_indi_names(given = "Joe", surname = "Bloggs") %>% 
   add_indi(sex = "F") %>% 
...
test_that("Function df_media() @ L561", {
  expect_snapshot_value(gedcom(subm("Me")) %>% 
...
test_that("Function df_sour() @ L588", {
  expect_snapshot_value(gedcom(subm("Me")) %>% 
...
test_that("Function df_repo() @ L611", {
  expect_snapshot_value(gedcom(subm("Me")) %>% 
...
test_that("Function df_note() @ L638", {
  expect_snapshot_value(gedcom(subm("Me")) %>% 
