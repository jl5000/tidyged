...
test_that("Function get_family_group_description() @ L88", {
...
test_that("Function df_individuals() @ L221", {
...
test_that("Function df_families() @ L279", {
  expect_snapshot_value(gedcom(subm("Me")) %>% 
   add_individual(sex = "M") %>% 
   add_individual_names("Joe /Bloggs/") %>% 
   add_individual(sex = "F") %>% 
...
test_that("Function df_multimedia() @ L313", {
  expect_snapshot_value(gedcom(subm("Me")) %>% 
...
test_that("Function df_sources() @ L340", {
  expect_snapshot_value(gedcom(subm("Me")) %>% 
...
test_that("Function df_repositories() @ L363", {
  expect_snapshot_value(gedcom(subm("Me")) %>% 
...
test_that("Function df_notes() @ L390", {
  expect_snapshot_value(gedcom(subm("Me")) %>% 
