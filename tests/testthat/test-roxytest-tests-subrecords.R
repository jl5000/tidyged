...
test_that("Function ASSOCIATION_STRUCTURE() @ L202", {
...
test_that("Function CHANGE_DATE() @ L237", {
...
test_that("Function CHILD_TO_FAMILY_LINK() @ L270", {
...
test_that("Function FAMILY_EVENT_DETAIL() @ L351", {
...
test_that("Function FAMILY_EVENT_STRUCTURE() @ L395", {
...
test_that("Function INDIVIDUAL_ATTRIBUTE_STRUCTURE() @ L435", {
...
test_that("Function INDIVIDUAL_EVENT_DETAIL() @ L490", {
...
test_that("Function INDIVIDUAL_EVENT_STRUCTURE() @ L524", {
...
test_that("Function MULTIMEDIA_LINK() @ L568", {
  expect_error(MULTIMEDIA_LINK("ref"))
})


test_that("Function NOTE_STRUCTURE() @ L591", {
...
test_that("Function PERSONAL_NAME_PIECES() @ L632", {
...
test_that("Function PERSONAL_NAME_STRUCTURE() @ L701", {
...
test_that("Function PLACE_STRUCTURE() @ L784", {
...
test_that("Function SOURCE_CITATION() @ L856", {
...
test_that("Function SOURCE_REPOSITORY_CITATION() @ L911", {
...
test_that("Function SPOUSE_TO_FAMILY_LINK() @ L941", {
