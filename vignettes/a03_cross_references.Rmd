...
In the above example a series of Individual records are created. After each record is created, the name(s) of the individual are defined without actually explicitly referencing the Individual record. This is because they are acting on the ***active record***. A record becomes active when it is created or when it is explicitly created.
...
Since the last record to the be created was the Note record, it is the active record. The active record is stored as an attribute of the tibble.
