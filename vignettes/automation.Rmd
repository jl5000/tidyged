...
```{r, error = TRUE}
simpsons %>% 
  add_famg(husband = "Simpson", wife = "Marge", children = c("Bart", "Lisa")) 
```
...
<p style="text-align: right;"><a href="https://jl5000.github.io/tidyged/articles/maintenance_functions.html">Next article: Maintenance functions ></a></p>
