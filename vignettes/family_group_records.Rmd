...
simpson_famg <- simpson_indis %>% 
  add_famg(husband = "@I1@", wife = find_indi_name(., "Marge"), 
           children = find_indi_name_all(., "Bart|Lisa"), number_of_children = 3)
...
You can see a summary of all events associated with a family group with the `fact_summary_famg()` function.
