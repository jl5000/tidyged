...
GEDCOM 5.5.5 files produced by **tidyged** should be compatible with other readers of GEDCOM 5.5.1 files (the most commonly supported version). In the event that a reader does not accept the file, all that should be required is the manual changing of the third line value to '5.5.1'. 
