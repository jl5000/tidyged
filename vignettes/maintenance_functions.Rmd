...
GEDCOM files can get very large and unwieldy, resulting in inefficiencies and file bloat. The **tidygedcom** package offers functions to automate the cleaning of GEDCOM files.
