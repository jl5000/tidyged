...
```{r}
get_indi_partners(three_gen, find_indi_name(three_gen, "Main")) %>% describe_records(gedcom = three_gen)
get_indi_parents(three_gen, find_indi_name(three_gen, "Main")) %>% describe_records(gedcom = three_gen)
get_indi_children(three_gen, find_indi_name(three_gen, "Main")) %>% describe_records(gedcom = three_gen)
